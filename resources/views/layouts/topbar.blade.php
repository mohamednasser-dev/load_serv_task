...
{{--                        <input type="text" class="form-control" placeholder="@lang('translation.Search...')" autocomplete="off" id="search-options" value="">--}}
                    ...
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            @if(Auth::check() && Auth::user()->avatar != '')
                                <img class="rounded-circle header-profile-user" src="{{ asset('images/' . Auth::user()->avatar) }}" alt="Header Avatar">
                            @else
                                <img class="rounded-circle header-profile-user" src="{{ asset('build/images/users/avatar-1.jpg') }}" alt="Header Avatar">
                            @endif
                            <span class="text-start ms-xl-2">
                                <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">{{ Auth::user()->name }}</span>
{{--                                <span class="d-none d-xl-block ms-1 fs-12 user-name-sub-text">{{ Auth::user()->phone }}</span>--}}
                            </span>
                        </span>
                    </button>
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="{{ route('profile.edit') }}"><i class="mdi mdi-account-circle text-muted fs-16 align-middle me-1"></i> <span class="align-middle">@lang('translation.Profile')</span></a>
